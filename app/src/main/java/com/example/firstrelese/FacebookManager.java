...
import com.example.firstrelese.network.ApiService;
...
public class FacebookManager {
    ...
    private Call<com.example.firstrelese.entities.AccessToken> call;
    ...
    private void getTokenFromBackend(String name, String email, String provider, String providerUserId){
        ...
        call.enqueue(new Callback<com.example.firstrelese.entities.AccessToken>() {
            @Override
            public void onResponse(Call<com.example.firstrelese.entities.AccessToken> call, Response<com.example.firstrelese.entities.AccessToken> response) {
            ...
            @Override
            public void onFailure(Call<com.example.firstrelese.entities.AccessToken> call, Throwable t) {
